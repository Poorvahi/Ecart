      ...
      <div class="container-menu-desktop">
        ...
        <div class="top-bar">
          <div class="content-topbar flex-sb-m h-full container">
            ...
            %>
              <a href="Userprofileserv?email=<%=newemail%>" class="flex-c-m trans-04 p-lr-25"> My Account </a>
              
               <%
                	String newmail = (String) request.getAttribute("email"); 
                %>
  			
  				<a href="Registration.jsp" class="flex-c-m trans-04 p-lr-25"> <%=newmail %> </a>
        ...
        <div class="wrap-menu-desktop">
          <nav class="limiter-menu-desktop container">
            <!-- Logo desktop -->
            <a href="#" class="logo">
              <h2 style="color: #717fe0">The ECart</h2>
        ...
        <ul class="topbar-mobile">
          ...
          <li>
            <div class="right-top-bar flex-w h-full">
              ...
              <a href="userprofile.jsp" class="flex-c-m p-lr-10 trans-04"> My Account </a>

              <a href="#" class="flex-c-m p-lr-10 trans-04"> INR </a>
 ...
 %>
    ...
    <section class="bg0 p-t-23 p-b-140">
      <div class="container">
        ...
        <a
                href="Homeproductdisplay?cnm=mobile"
          ...
          <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
            ...
            <div class="block1 wrap-pic-w">
              ...
              <a
                href="Homeproductdisplay?cnm=watches"
                class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3"
              >
                <div class="block1-txt-child1 flex-col-l">
                  <span class="block1-name ltext-102 trans-04 p-b-8">
          ...
          <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
            ...
            <div class="block1 wrap-pic-w">
              ...
              <a
                href="Homeproductdisplay?cnm=headphones"
                class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3"
              >
                <div class="block1-txt-child1 flex-col-l">
                  <span class="block1-name ltext-102 trans-04 p-b-8">
...
<%
    ...
    <div class="product-grid">
	    ...
	    <div class="block2">
	        ...
	        <a href="Productusersearch?pid=<%= gt.getProductid() %>">
	            <img src="img/<%= gt.getImage() %>"  width="300" height="200" alt="Product 1">
	        </a>
	        </div>
	        <a href="Productsearchonclickimg?pid=<%= gt.getProductid() %>" class="product-name"><br><%= gt.getProductname() %></a>
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-lg-5 p-b-30">
              <div class="p-r-50 p-t-5 p-lr-0-lg">
                ...
                <span class="mtext-106 cl2"> Rs.5,000 onwards </span>

                <p class="stext-102 cl3 p-t-23">
                  Enjoy latest and wide range of home decor items and launched appliances to ease your burden and creating a beautiful life.
                </p>

                <!--  -->
                <div class="p-t-33">
                  <div class="flex-w flex-r-m p-b-10">
                    <div class="size-203 flex-c-m respon6">Capacity</div>
