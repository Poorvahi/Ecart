...
<body>
<% 
		Userget u= (Userget) session.getAttribute("adminprofile");
		if(u!=null)
		{
	%>
    <div class="container">
        ...
        <div class="data">
            <form action="UpdateAdmin1" method="post">
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="role" id="" readonly value="<%=u.getRole()%>">
                </div>
    ...
    <%
			...
			out.println("No record found at this adminname");
		}
    %>
</body>
</html>