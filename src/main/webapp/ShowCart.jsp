        ...
        <div class="top-bar">
          <div class="content-topbar flex-sb-m h-full container">
            <div class="left-top-bar">
              Free shipping for standard order Rs.15,000.
            </div>
                <%
            ...
            <div class="right-top-bar flex-w h-full">
              ...
              <a href="Userprofileserv?email=<%=newmail%>" class="flex-c-m trans-04 p-lr-25"> My Account </a>
...
<div class="container">
              ...
              <div class="wrap-table-shopping-cart">
                <table class="table-shopping-cart">
                  <tr class="table_head">
                    ...
                    <th class="column-6">Remove Button</th>
                    
                    
                  </tr>
                   <%
		DatabaseCon db1= new DatabaseCon();
		ArrayList cartget=db1.showcart(newmail);
                  ...
                  <tr class="table_row">
                    ...
                    <td class="column-4">
                      <div class="wrap-num-product flex-w m-l-auto m-r-0">
                        <a href="PriceDecrement?qty=<%=gt.getQuantity() %>&price=<%=gt.getPrice() %>&cartid=<%= gt.getCartid() %>" >
                        <div
                        ...
                        <a href="PriceIncrement?qty=<%= gt.getQuantity()%>&price=<%= gt.getPrice() %>&cartid=<%= gt.getCartid() %>" >
                        <div
                    ...
                    <a class="btn btn-outline-danger" href="RemoveCartProduct?cartid=<%= gt.getCartid() %>" role="button">
				       Remove
				    </a>
	...
	%>		
               ...
               <%
		DatabaseCon db3= new DatabaseCon();
		Double grandtotal=db3.grandtotal(newmail);
		session.setAttribute("grandtotal",grandtotal);
		
	%>
              
		<h4 class="text-uppercase" style="margin:3% 0% 0% 50%;">Grand Total :<%= grandtotal%></h4>
		</div>
		</div>
		</div>
              <div
              ...
              >
                  ...
                  <a class="btn btn-primary btn-lg" href="Homeuser.jsp">
                    Continue Shopping
                  </a>
                ...
                <div class="flex-w flex-m m-r-20 m-tb-5">
                  ...
                  >
                  <form id="paymentForm">
			        <input type="number" name="amount" id="amount" value="<%= grandtotal %>" readonly>
            ...
            .then(order => {
                const options = {
                    ...
                    handler: function (response) {
                        ...
                        window.location.href = "Success2.jsp?payment_id=" + response.razorpay_payment_id;
                    },
                    prefill: {
                        name: "Student User",
