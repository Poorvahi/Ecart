        ...
        <div class="top-bar">
          <div class="content-topbar flex-sb-m h-full container">
            ...
            <div class="right-top-bar flex-w h-full">
              ...
              <a href="UserProfile?email=<%= newmail %>" class="flex-c-m trans-04 p-lr-25"> My Account </a>
      ...
      <div class="container">
        ...
        <div class="con2">
          <h3 class="ltext-103 cl5">Product Overview</h3>
           ...
           <%
                        ArrayList al2=(ArrayList)session.getAttribute("productget2");
                        if(al2 !=null) {
    ...
    <div class="product-card">
      <div class="product-info-container">
        ...
        <div class="product-details">
          <a href="Productusersearch?pid=<%= gt.getProductid() %>" class="product-name">
            <%=gt.getProductname() %>
          </a>
