...
<body>
  ...
  <div class="btn-back-to-top" id="myBtn">
	...
	<%
	 Productget st2 = (Productget) session.getAttribute("productget");
	if(st2 != null){
...
<input type="text" name="productid" class="n1" value="<%= st2.getProductid() %>">      
<input type="text" name="name" class="n1" value="<%= st2.getProductname() %>">
            ...
            .then(order => {
                const options = {
                    ...
                    handler: function (response) {
                        ...
                        window.location.href = "PaymentSuccess.jsp?payment_id=" + response.razorpay_payment_id;
                    },
                    prefill: {
                        name: "Student User",
