...
function showHint(str) {
  ...
  <body class="animsition">
  	<form action="contact.java" method="post">
    <!-- Header -->
          ...
          <nav class="limiter-menu-desktop container">
            ...
            <div class="menu-desktop">
              ...
              <li>
                ...
                <li>
                  <a href="Blogwihtoutlogin.jsp">Blog</a>
                </li>
          ...
          >
            ...
            <div class="flex-w w-full p-b-42">
              ...
              <div class="size-212 p-t-2">
                ...
                <p class="stext-115 cl1 size-213 p-t-18">+91 9285246390</p>
              </div>
            </div>
            ...
            <div class="flex-w w-full">
              ...
              <div class="size-212 p-t-2">
                <span class="mtext-110 cl2"> For Support Contact </span>
    ...
    <div class="map">
      <div
        ...
        data-map-x="22.7196"
        data-map-y="75.8577"
        data-pin="http://maps.google.com/mapfiles/ms/icons/red-dot.png"
        data-scrollwhell="0"
        data-draggable="1"
        data-zoom="11"
      ></div>
