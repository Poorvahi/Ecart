...
function showHint(str) {
  ...
  <body class="animsition">
    ...
    <header>
        ...
        <div class="top-bar">
          <div class="content-topbar flex-sb-m h-full container">
            <div class="left-top-bar">
              Free shipping for standard order 15,000Rs.
            </div>
      ...
      <div class="menu-mobile">
        <ul class="topbar-mobile">
          <li>
            <div class="left-top-bar">
              Free shipping for standard order over 15,000Rs.
            </div>
          </li>
    ...
    <div>
    	<nav class="link-list">
	    <a href="Showsubrelatedproductswithoutlogin?subnm=<%=sget.getSubnm()%>&cnm=<%=sget.getCnm()%>"><%=sget.getSubnm()%></a>
	  </nav> 
    ...
    <div class="product-card">
      <div class="product-info-container">
        ...
        <div class="product-details">
          <a href="Productusersearch2?pid=<%=gt.getProductid()%>" class="product-name">
            <%=gt.getProductname() %>
          </a>
