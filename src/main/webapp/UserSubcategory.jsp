...
function showHint(str) {
  ...
  <body class="animsition">
    ...
    <header>
      ...
      <div class="menu-mobile">
        <ul class="topbar-mobile">
          <li>
            <div class="left-top-bar">
              Free shipping for standard order over 10,000Rs.
            </div>
          </li>
	...
	<%
			ArrayList al=(ArrayList)session.getAttribute("subcatget");
		if(al !=null)
		{
    ...
    <div>
    	<nav class="link-list">
	    <a href="Showsubrelatedproducts?subnm=<%=sget.getSubnm()%>&cnm=<%=sget.getCnm()%>"><%=sget.getSubnm()%></a>
	  </nav> 
      ...
      <div class="container">
        ...
        <div class="con2">
          <h3 class="ltext-103 cl5">Product Overview</h3>
           ...
           <%
                        ArrayList al2=(ArrayList)session.getAttribute("relatedproductget");
                        if(al2 !=null) {
    ...
    <div class="product-card">
      <div class="product-info-container">
        ...
        <div class="product-image">
          <a href="Productsearchuserside?pid">
            <img src="img/<%=gt.getImage() %>" width="300" height="300" alt="Product Image">
          </a>
        </div>

        <!-- Text Content Section -->
        <div class="product-details">
          <a href="Productsearchonclickimg?pid=" class="product-name">
            <%=gt.getProductname() %>
          </a>
          <div class="product-price">Price:<%=gt.getPrice() %> </div>
          <div class="product-description"><%=gt.getDescription() %></div>
        </div>
      </div>
    </div>
  </div>
