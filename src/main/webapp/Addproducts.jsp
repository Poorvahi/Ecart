	 ...
	 <div class="main">
        ...
        <form action="Addproduct" method="post">
            ...
            <div class="pname">
                ...
                <input type="text" name="productname" placeholder="Product_Name" id="" ><br><br></div>
                <div id="ip1">
                    <label for="">Price</label>
                    <label for="" id="b1">Category</label><br>
                     <input type="number" name="price" placeholder="Price" id="">
                     <input type="text" name="subcategory" placeholder="category" id=""><br>
                </div>
                <textarea name="description" placeholder="Description" id="desc" ></textarea><br>
               <div id="ip2">
                    <label for="">Brand</label>
                    <label for="" id="b1">Quantity</label><br>
                    <input type="text" name="brand" placeholder="Brand" id="">
                    <input type="number" name="quantity" placeholder="Quantity" id="" ><br><br>
               </div>
