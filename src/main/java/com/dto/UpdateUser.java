...
public class UpdateUser extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean result1=db.updateuseradmin(unm,fnm,lnm,passwd,email,contact,gen,dob,addr,state,city,postal,role);
		boolean result2=db.updateuserlogin(unm,passwd,role,email,contact);
		if(result1 && result2) {
