...
public class Adduser extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean result1=db.Adduser(unm,fnm,lnm,passwd,cpasswd,em,contact,gen,dob,addr,state,city,postal,role);
		boolean result2=db.Adduserlogin(unm,passwd,role,em,contact);
		if(result1 && result2) {
