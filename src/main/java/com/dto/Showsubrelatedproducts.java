...
/**
 * Servlet implementation class Showsubrelatedproducts
 */
@WebServlet("/Showsubrelatedproducts")
public class Showsubrelatedproducts extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Showsubrelatedproducts() {
        super();
